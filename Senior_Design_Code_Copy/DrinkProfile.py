...
class DrinkProfile:
    ...
    drink_profile_directory = "drink_profiles"
    ...
    def getDrinkProfile(self):
        ...
        file = open(self.drink_txt_file,'r')
        line_count = 1
        for line in file:
            if line_count == 1:
    ...
    def createDrinkProfile(self,desired_pic_path=None):
        ...
        *Drinks are by default active until changed to inactive in GUI."""
        ...
        new_text_file = open("test_drink_2.txt","w")
        ...
        new_text_file.write("isUrl " + self.isUrl+"\n")
        ...
        if self.isUrl != "False":
            ...
            if desired_pic_path == None:
                ...
                shutil.copyfile(desired_pic_path,
                                "/Users/Cabla/Documents/PYTHON_MODULES/SENIOR_DESIGN_CODE/"+self.pic_location)
...
def testExistingDrink():
    ...
    test_drink = DrinkProfile(
        "/Users/Cabla/Documents/PYTHON_MODULES/SENIOR_DESIGN_CODE/drink_profiles/cuba_libre/cuba_libre.txt")
...
def testNewDrink():
    ...
    test_drink2.createDrinkProfile("/Users/Cabla/Pictures/drink.jpg")    
...
def testDeletingADrinkProfile():
    ...
    test_drink4 = DrinkProfile(
        "/Users/Cabla/Documents/PYTHON_MODULES/SENIOR_DESIGN_CODE/drink_profiles/Test_drink_2/test_drink_2.txt")
    test_drink4.deleteDrinkProfile()


def testEditDrinkProfile():
    """Tests editing a drink profile."""
    test_drink5 = DrinkProfile(
        "/Users/Cabla/Documents/PYTHON_MODULES/SENIOR_DESIGN_CODE/drink_profiles/Test_drink_2/test_drink_2.txt")
    ...
    test_drink5.edited_attributes[5] = test_drink5.isActive
    test_drink5.edited_attributes[6] = test_drink5.price
